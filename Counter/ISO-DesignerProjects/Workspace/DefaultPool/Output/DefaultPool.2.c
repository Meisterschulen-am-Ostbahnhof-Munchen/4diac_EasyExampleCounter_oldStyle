...
const unsigned long ISO_OP_MEMORY_CLASS isoOP_DefaultPool_Offset[] = {
	   ...
	   217,  // SoftKey_PlusPlus_Offset
	   230,  // SoftKey_Reset_Gesamtzaehler_Offset
	   243,  // SoftKey_Reset_Tageszaehler_Offset
	   256,  // SoftKey_MinusMinus_Offset
	   269,  // Button_PlusPlus_Offset
	   288,  // Button_Reset_Gesamtzaehler_Offset
	   307,  // Button_Reset_Tageszaehler_Offset
	   326,  // Button_MinusMinus_Offset
	   345,  // InputNumber_Gesamtziel_Offset
	   383,  // InputNumber_Tagesziel_Offset
	   421,  // OutputString_Fasszaehler_Offset
	   450,  // OutputString_Reset_Gesamtzaehler_Offset
	   480,  // OutputString_Gesamtzaehler_Offset
	   509,  // OutputString_Tageszaehler_Offset
	   537,  // OutputString_Reset_Tageszaehler_Offset
	   566,  // OutputString_SoftKey_Reset_Gesamtzaehler_Offset
	   596,  // OutputString_SoftKey_Reset_Tageszaehler_Offset
	   625,  // OutputString_Ziel_Offset
	   646,  // OutputString_ZielErreicht_Offset
	   676,  // OutputNumber_Tageszaehler_Offset
	   705,  // OutputNumber_Gesamtzaehler_Offset
	   734,  // Rectangle_Box_Offset
	   747,  // Meter_Gesamtzaehler_Offset
	   768,  // Meter_Tageszaehler_Offset
